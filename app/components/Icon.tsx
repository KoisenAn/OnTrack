  ...
  switch (iconLibrary) {
    case 'fontawesome':
      if (name === 'social') {
        ...
        return <FontAwesome name="area-chart" size={size} color={color} />;
      }
      else {
    ...
    case 'fontawesome5':
      if (name === 'social') {
        ...
        return <FontAwesome5 name="area-chart" size={size} color={color} />;
      }
      else {
    ...
    case 'fontawesome6':
      ...
      if (name === 'social') {
        return <FA6Component name="users" size={size} color={color} />;
      } 
      else if (name === 'settings') {
        return <FontAwesome5 name="cog" size={size} color={color} />;
      }
        ...
        return <FA6Component name="list" size={size} color={color} />;
      }
      else if (name === 'stats') {
        return <FA6Component name="chart-simple" size={size} color={color} />;
      }
      else {
        return <FA6Component name={name} size={size} color={color} />;
      }
    case 'feather':
    default:
      if (name === 'social') {
